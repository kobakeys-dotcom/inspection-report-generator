import { CladdingFrameRfiFormData, CF_PROJECT_INFO } from '@/types/claddingFrameRfi';
import hdcLogo from '@/assets/hdc-logo.png';
import bltLogo from '@/assets/blt-logo.png';

interface CfRfiPage1Props {
...
const CfRfiPage1 = ({ data, onChange }: CfRfiPage1Props) => {
  return (
      ...
      <div className="p-[20px]">
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="text-[8px] mt-[1px]">{CF_PROJECT_INFO.form_number}</div>
          </div>
        ...
        <div className="flex items-start mb-[6px]">
          <table className="border-collapse" style={{ width: '58%' }}>
            <tbody>
              ...
              {[
                ['Project', CF_PROJECT_INFO.project],
                ['Contractor', CF_PROJECT_INFO.contractor],
                ['Contract No', CF_PROJECT_INFO.contract_no],
                ['Client', CF_PROJECT_INFO.client],
              ].map(([label, value], i) => (
                <tr key={label}>
        ...
        <table className="w-full border-collapse mb-[6px]">
          <tbody>
            ...
            {[1, 2, 3, 4, 5].map((num) => {
              const key = `inspection_item_${num}` as keyof CladdingFrameRfiFormData;
              return (
                <tr key={num}>
